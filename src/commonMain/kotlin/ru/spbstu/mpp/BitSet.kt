 ...
 * @since 0.8.0
 */
class BitSet : Iterable<Int>, WordArray {
    /**
     ...
     * @return cardinality
     */
    fun andcardinality(bs: WordArray): Int {
        var sum = 0
        for (k in 0 until min(getNumberOfWords(), bs.getNumberOfWords())) {
     ...
     * @return cardinality
     */
    fun andNotcardinality(bs: WordArray): Int {
        var sum = 0
        for (k in 0 until min(getNumberOfWords(), bs.getNumberOfWords())) {
    ...
    override fun equals(o: Any?): Boolean {
        if (o is WordArray) {
            ...
            val longer: WordArray = if (bs.getNumberOfWords() < getNumberOfWords()) this else bs
            for (k in min(
                getNumberOfWords(),
                bs.getNumberOfWords()
            ) until max(
     ...
     */
    fun intersects(bs: WordArray): Boolean {
        for (k in 0 until min(getNumberOfWords(), bs.getNumberOfWords())) {
     ...
     * @return cardinality
     */
    fun orcardinality(bs: WordArray): Int {
        var sum = 0
        for (k in 0 until min(getNumberOfWords(), bs.getNumberOfWords())) {
     ...
     * @return cardinality
     */
    fun xorcardinality(bs: WordArray): Int {
        var sum = 0
        for (k in 0 until min(getNumberOfWords(), bs.getNumberOfWords())) {
    ...
    override fun getNumberOfWords(): Int {
        return data.size
    }

    override fun getWord(index: Int): Int {
        return data[index]
    }
